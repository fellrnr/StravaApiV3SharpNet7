...
namespace de.schumacher_bw.Strava.Model
{
    ...
    public class LatLngStream : IStream
    {
        private LatLngStream() {}
        ...
        /// <summary>The sequence of lat/long values for this stream</summary>
        [JsonProperty("data")]
        public LatLng[] Data 
        {
            get => (LatLng[])_Data?.Clone();
            private set => _Data = value;
        }
        private LatLng[] _Data;
